...
VERSION='local-hog-color-20260916-v2-raw-contrast'
...
def detect(im,group,keep_rejected=False):
    ...
    hp=v.contrast(im)
    # Raw spatial contrast keeps identifiable insects that stay in one place.
    contrast=cv2.GaussianBlur(hp,(0,0),2.2)
